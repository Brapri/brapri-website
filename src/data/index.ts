...
export const cases = [
  {
    ...
    title: 'CRM Enterprise para a Eltech Química',
    summary: 'Sistema web de gestão comercial desenvolvido do zero: pipeline de propostas, agenda de atividades, gestão de clientes, estoque, compras, expedição e emissão fiscal — substituindo planilhas em toda a operação comercial da indústria química.',
    result: '360°',
    resultLabel: 'visão do processo comercial em um único sistema',
  ...
  },
  {
    ...
    title: 'Plataforma social para criadores de conteúdo',
    summary: 'App web e desktop (Tauri) para a Flamus, plataforma avançada de social media para criadores. Backend de alta performance em ElysiaJS + Bun, frontend em Next.js e distribuição cross-platform desktop e web com base de código unificada.',
    result: '2',
    resultLabel: 'plataformas — web e desktop — com um único backend',
  ...
  },
  {
    ...
    title: 'Sistema de recadastramento da AAC Nacional',
    summary: 'Sistema web para a Associação de Aposentados dos Correios gerenciar o recadastramento nacional de associados: autenticação via Google OAuth (Clerk), controle de permissões por papel, automações de fluxo de aprovação e painel administrativo com relatórios.',
    result: 'Nacional',
    resultLabel: 'Associação de Aposentados dos Correios — cobertura Brasil',
